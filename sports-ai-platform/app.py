...
def render_ai_dashboard():
    ...
    for i, item in enumerate(ranked, 1):
        st.success(
            f"{i}. {item['pick']}｜{item['stars']}｜{item['confidence']:.1f}%｜{item['sport']}｜{item['match']}｜比分 {item['score']}｜{item['status']}"
        )
...
with sport_tab1:
    ...
    try:
        ...
        matches, used_demo = add_demo_if_empty(matches, make_demo_football_matches(), min_count=6)
...
with sport_tab2:
    ...
    try:
        ...
        games, used_demo = add_demo_if_empty(games, make_demo_baseball_games(), min_count=12)
...
with sport_tab3:
    ...
    try:
        ...
        games, used_demo = add_demo_if_empty(games, make_demo_basketball_games(), min_count=6)
